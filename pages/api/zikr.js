...
//                                 private?, approved? }
//   zikr_members/{gid}/{uid} = { email, name?, picture? (nom/photo Google au
//                                 moment de rejoindre, affichage seulement —
//                                 voir chatDisplayName), fait, rythme,
//                                 avertissement?, joinedAt, updatedAt,
...
//                                 jamais de job de remise à zéro à
//                                 programmer, lastRecitingPushAt? — throttle
//                                 du push « reprise d'activité » (voir
//                                 notifyReciting) }
//   zikr_requests/{gid}/{uid}= { email, name?, picture?, at }
