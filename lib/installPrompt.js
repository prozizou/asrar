...
export function isStandalone() {
  ...
  return (
    ...
    // navigator.standalone : propriété propriétaire iOS Safari, absente du type Navigator standard.
    // @ts-expect-error -- API non standard, spécifique à iOS Safari (PWA installée)
