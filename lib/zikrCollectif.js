...
export function updateGroup(groupId, { name, presetId, arabic, target, private: isPrivate }) {
  return apiPost('zikr', { action: 'update', groupId, name, presetId, arabic, target, private: isPrivate });
}
