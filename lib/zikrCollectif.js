...
export function createGroup({ name, phrase, target, amount }) {
  return apiPost('zikr', { action: 'create', name, phrase, target, amount });
}
export function getGroup(groupId) {
  return apiPost('zikr', { action: 'get', groupId });
}
export function joinGroup(groupId, amount) {
  return apiPost('zikr', { action: 'join', groupId, amount });
}
