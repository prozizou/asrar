...
function getAudioCtx() {
    if (!audioCtx) {
        // webkitAudioContext : préfixe legacy Safari/iOS, absent des types DOM standards.
        // @ts-expect-error -- vendor prefix non typé, repli volontaire pour anciens WebKit
