...
// élargie de 6 à 10 min (2026-09) pour absorber les à-coups du pinger externe
// (cron-job.org, hors dépôt) sans faire manquer une occurrence pour un simple
// retard d'une ou deux minutes.
export const WEB_ALARM_WINDOW_MS = 10 * 60 * 1000;
