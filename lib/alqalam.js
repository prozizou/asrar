...
// Carlito/Calibri ne couvrent QUE le latin (voir commentaire plus haut) : pour
// le texte arabe (l'essentiel du document), on tombe sur ce qui suit dans la
// pile. « sans-serif » seul laissait le navigateur choisir une police arabe
// au hasard, souvent sans réelle graisse Bold dessinée (juste un faux-gras
// approximatif, ou rien de visible) — d'où le rendu perçu comme non-gras. On
// liste explicitement des polices arabes très répandues qui possèdent, elles,
// une vraie graisse Bold (Segoe UI/Tahoma sous Windows, Noto Naskh/Sans Arabic
// ailleurs), pour maximiser les chances d'un vrai gras plutôt qu'un repli muet.
const pdfTextStyle = (fontSizePt) => `
  font-family: Carlito, Calibri, 'Segoe UI', Tahoma, Arial, 'Noto Naskh Arabic', 'Noto Sans Arabic', sans-serif;
  font-weight: 700;
