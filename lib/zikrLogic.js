 ...
 * @param {{name?:string, presetId?:string, arabic?:string, target?:number|string, private?:boolean}} input
 * @returns {{name:string, presetId:string, arabic:string, transliteration:string, target:number, private:boolean}
...
export function normalizeGroupInput(input) {
  ...
  return { name, presetId, arabic, transliteration: preset.transliteration, target, private: isPrivate };
}
