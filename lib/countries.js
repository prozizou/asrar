// lib/countries.js — Code pays ISO 3166-1 alpha-2 → nom français.
// Utilisé par pages/api/track.js pour résoudre un nom lisible à partir de
// l'en-tête de géolocalisation Vercel (x-vercel-ip-country, code alpha-2 seul).
// Source unique : ni le client ni l'admin ne dupliquent cette table — l'admin
// affiche le nom déjà enregistré par ce fichier au moment de la connexion.
export const COUNTRY_NAMES = {
  ...
  AR: "Argentine", AS: "Samoa américaines", AT: "Autriche", AU: "Australie", AW: "Aruba",
  AX: "Åland", AZ: "Azerbaïdjan", BA: "Bosnie-Herzégovine", BB: "Barbade", BD: "Bangladesh",
  BE: "Belgique", BF: "Burkina Faso", BG: "Bulgarie", BH: "Bahreïn", BI: "Burundi",
  BJ: "Bénin", BL: "Saint-Barthélemy", BM: "Bermudes", BN: "Brunei", BO: "Bolivie",
  BQ: "Bonaire, Saint-Eustache et Saba", BR: "Brésil", BS: "Bahamas", BT: "Bhoutan",
  BV: "Île Bouvet", BW: "Botswana", BY: "Biélorussie", BZ: "Belize", CA: "Canada",
  CC: "Îles Cocos", CD: "RD Congo", CF: "République centrafricaine", CG: "Congo",
  CH: "Suisse", CI: "Côte d'Ivoire", CK: "Îles Cook", CL: "Chili", CM: "Cameroun",
  CN: "Chine", CO: "Colombie", CR: "Costa Rica", CU: "Cuba", CV: "Cap-Vert",
  CW: "Curaçao", CX: "Île Christmas", CY: "Chypre", CZ: "Tchéquie", DE: "Allemagne",
  ...
  GP: "Guadeloupe", GQ: "Guinée équatoriale", GR: "Grèce",
  ...
  HN: "Honduras", HR: "Croatie", HT: "Haïti", HU: "Hongrie", ID: "Indonésie",
  ...
  KN: "Saint-Christophe-et-Niévès", KP: "Corée du Nord", KR: "Corée du Sud",
  KW: "Koweït", KY: "Îles Caïmans", KZ: "Kazakhstan", LA: "Laos", LB: "Liban",
  LC: "Sainte-Lucie", LI: "Liechtenstein", LK: "Sri Lanka", LR: "Liberia",
  ...
  MK: "Macédoine du Nord", ML: "Mali", MM: "Birmanie", MN: "Mongolie", MO: "Macao",
  ...
  PG: "Papouasie-Nouvelle-Guinée", PH: "Philippines", PK: "Pakistan", PL: "Pologne",
  PM: "Saint-Pierre-et-Miquelon", PN: "Îles Pitcairn", PR: "Porto Rico",
  ...
  ST: "Sao Tomé-et-Principe", SV: "Salvador", SX: "Saint-Martin (Pays-Bas)",
  SY: "Syrie", SZ: "Eswatini", TC: "Îles Turques-et-Caïques", TD: "Tchad",
  TF: "Terres australes françaises", TG: "Togo", TH: "Thaïlande", TJ: "Tadjikistan",
  TK: "Tokelau", TL: "Timor oriental", TM: "Turkménistan", TN: "Tunisie",
  TO: "Tonga", TR: "Turquie", TT: "Trinité-et-Tobago", TV: "Tuvalu", TW: "Taïwan",
  TZ: "Tanzanie", UA: "Ukraine", UG: "Ouganda",
...
// countryCode alpha-2 (Vercel envoie parfois "XX"/"T1" pour Tor/inconnu) →
// { country, countryCode } ; jamais null pour countryCode (utile pour le
// drapeau ​​même quand le nom est absent de la table).
export function resolveCountry(codeRaw) {
  const code = String(codeRaw || "").trim().toUpperCase();
  if (!code || code.length !== 2) return { country: "", countryCode: "" };
  return { country: COUNTRY_NAMES[code] || code, countryCode: code };
}
