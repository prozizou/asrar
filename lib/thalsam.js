...
// erreur dans la version initiale) ; ديش/دديش/طش/ياش puis عيوش/ميش/ءيل/
// ئيل/يئيل/دوش/لوش/يوش/هيش/كطيش ajoutées — 19 au total. Les 3 en ل
// (ءيل/ئيل/يئيل) ne partagent pas le suffixe ش commun aux 16 autres :
// aucun code ne suppose de motif partagé, la liste reste une énumération
// fermée arbitraire, comme le veut la spécification (§5).
export const ENDINGS = [
  'ش', 'عيش', 'طيش', 'يش', 'وش', 'ديش', 'دديش', 'طش', 'ياش',
  'عيوش', 'ميش', 'ءيل', 'ئيل', 'يئيل', 'دوش', 'لوش', 'يوش', 'هيش', 'كطيش',
];
