...
export function buildCsp() {
  return [
    ...
    // Vocaux de la discussion d'un zikr collectif (app/zikr/page.tsx),
    // hébergés sur Cloudinary — sans media-src, un <audio> retombe sur
    // default-src ('self'), qui bloquerait sa lecture. blob: pour la
    // prévisualisation locale d'un enregistrement AVANT son envoi effectif.
